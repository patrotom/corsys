...
INSERT INTO `user` (`user_id`, `active`, `username`, `password`, `email`, `first_name`, `last_name`, `phone`, `role_id`) VALUES (1, 1, 'tereza.stechova', 'X03MO1qnZdYdgyfeuILPmQ==', 'Tereza.stechova@seznam.cz', 'Tereza', 'Štěchová', '+420734929900', 2);
INSERT INTO `user` (`user_id`, `active`, `username`, `password`, `email`, `first_name`, `last_name`, `phone`, `role_id`) VALUES (2, 1, 'valerie.bukackova', 'X03MO1qnZdYdgyfeuILPmQ==', 'Valerie.Bukackova@seznam.cz', 'Valérie', 'Bukáčková', '+420722153768', 2);
INSERT INTO `user` (`user_id`, `active`, `username`, `password`, `email`, `first_name`, `last_name`, `phone`, `role_id`) VALUES (3, 1, 'slavomir.malina', 'X03MO1qnZdYdgyfeuILPmQ==', 'Slavomir.Malina@seznam.cz', 'Slavomír', 'Malina', '+420738770452', 2);
INSERT INTO `user` (`user_id`, `active`, `username`, `password`, `email`, `first_name`, `last_name`, `phone`, `role_id`) VALUES (4, 1, 'erik.husak', 'X03MO1qnZdYdgyfeuILPmQ==', 'Erik.Husak@seznam.cz', 'Erik', 'Husák', '+420723319551', 2);
INSERT INTO `user` (`user_id`, `active`, `username`, `password`, `email`, `first_name`, `last_name`, `phone`, `role_id`) VALUES (5, 1, 'lubomir.juchelka', 'X03MO1qnZdYdgyfeuILPmQ==', 'Lubomir.Juchelka@seznam.cz', 'Lubomír', 'Juchelka', '+420720353671', 2);
INSERT INTO `user` (`user_id`, `active`, `username`, `password`, `email`, `first_name`, `last_name`, `phone`, `role_id`) VALUES (6, 1, 'marek.kunes', 'X03MO1qnZdYdgyfeuILPmQ==', 'Marek.Kunes@seznam.cz', 'Marek', 'Kuneš', '+420734711257', 1);
INSERT INTO `user` (`user_id`, `active`, `username`, `password`, `email`, `first_name`, `last_name`, `phone`, `role_id`) VALUES (7, 1, 'oto.slajs', 'X03MO1qnZdYdgyfeuILPmQ==', 'Oto.slajs@seznam.cz', 'Oto', 'Šlajs', '+420738780848', 1);
INSERT INTO `user` (`user_id`, `active`, `username`, `password`, `email`, `first_name`, `last_name`, `phone`, `role_id`) VALUES (8, 1, 'vaclav.veleba', 'X03MO1qnZdYdgyfeuILPmQ==', 'Vaclav.Veleba@seznam.cz', 'Václav', 'Veleba', '+420739562521', 1);
INSERT INTO `user` (`user_id`, `active`, `username`, `password`, `email`, `first_name`, `last_name`, `phone`, `role_id`) VALUES (9, 1, 'lubomir.vavra', 'X03MO1qnZdYdgyfeuILPmQ==', 'Lubomir.Vavra@seznam.cz', 'Lubomír', 'Vávra', '+420608644368', 1);
INSERT INTO `user` (`user_id`, `active`, `username`, `password`, `email`, `first_name`, `last_name`, `phone`, `role_id`) VALUES (10, 1, 'vendula.vabelkova', 'X03MO1qnZdYdgyfeuILPmQ==', 'Vendula.Kabelkova@seznam.cz', 'Vendula', 'Kabelková', '+420770297628', 1);
